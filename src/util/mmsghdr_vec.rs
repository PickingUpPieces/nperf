...
impl MmsghdrVec {
    ...
    pub fn new(packet_buffer_vec: Vec<PacketBuffer>) -> MmsghdrVec {
        ...
        for packet_buffer in packet_buffer_vec {
            datagram_size = packet_buffer.datagram_size;
            packets_amount_per_msghdr = packet_buffer.packets_amount;
