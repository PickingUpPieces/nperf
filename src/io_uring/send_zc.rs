...
impl IoUringOperatingModes for IoUringSendZc {
    type Mode = IoUringSendZc;

    fn new(parameter: Parameter, io_uring_fd: Option<RawFd>) -> Result<IoUringSendZc, &'static str> {
